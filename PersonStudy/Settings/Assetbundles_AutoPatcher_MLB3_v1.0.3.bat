...
set defaultPath="C:\Program Files\Unity\Hub\Editor\2021.3.11f1\Editor\Unity.exe" -batchmode -projectPath 

:: [END] 유니티 프로젝트 경로 세팅 ※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※

echo ================================================================================================================
echo.
echo                     AssetBundles Patch Program_MLB3(ver1.0.3)
echo.
echo ================================================================================================================
echo.
...
set patchPath=F:\MLB3_Client\%patchPath%\Assetbundle_%patchType%_%patchPath%
...
echo      Ex)    092   /    100    /    152
echo.
echo      온점(.)을 반드시 미기입해야하며, 기입 시 세팅이 올바르게 되지 않을 수 있습니다.
echo.
echo ================================================================================================================
echo.
...
if %patchType% == aOS set settingsPath=\Settings\Build\aOS\aOS_10_abPatchSetup.gBuild
...
if %patchType% == aOS set patchMethod= -executeMethod Gong.Build.AutoBuilder.BuildFromArgs --BuildTargetGroup "Android" --BuildTarget "Android" --BuildScriptSymbols "%symbolsList%" --BuildSettingFile "%patchPath%%settingsPath%"
if %patchType% == iOS set patchMethod= -executeMethod Gong.Build.AutoBuilder.BuildFromArgs --BuildTargetGroup "iPhone" --BuildTarget "iPhone" --BuildScriptSymbols "%symbolsList%" --BuildSettingFile "%patchPath%%settingsPath%"
...
if %patchType% == aOS set settingsPath=\Settings\Build\aOS\aOS_11_abPatchOutput.gBuild
...
start %patchPath%/_Bundles_/%patchType%
